...
public class DriverDetailsController {
	...
	@PostMapping(value="/confirmRide/{bookingId}/{status}")
	public String confirmRide(@PathVariable int bookingId, @PathVariable String status) {
		return dao.acceptRejectRide(bookingId, status);
	}
